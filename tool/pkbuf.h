 ...
 */
int  pkbuf_header(pkbuf_t *pkbuf, c_int16_t size);
 ...
 */
pkbuf_t* pkbuf_copy_partial(pkbuf_t *pkbuf,
 ...
 * @param len       length of data to copy
 */
int pkbuf_tobuf_partial(pkbuf_t *pkbuf,
