...
static asn_TYPE_member_t asn_MBR_UETNLABindingReleaseRequest_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct UETNLABindingReleaseRequest, protocolIEs),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolIE_Container_127P75,
		0,
		{ 0, 0, 0 },
...
static asn_SEQUENCE_specifics_t asn_SPC_UETNLABindingReleaseRequest_specs_1 = {
