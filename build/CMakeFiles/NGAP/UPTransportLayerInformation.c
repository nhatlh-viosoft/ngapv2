...
asn_TYPE_member_t asn_MBR_UPTransportLayerInformation_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct UPTransportLayerInformation, choice.gTPTunnel),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UPTransportLayerInformation, choice.choice_Extensions),
...
asn_TYPE_descriptor_t asn_DEF_UPTransportLayerInformation = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_UPTransportLayerInformation_constr_1, CHOICE_constraint },
