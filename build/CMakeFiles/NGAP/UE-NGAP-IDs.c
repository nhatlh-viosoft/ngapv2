...
static asn_per_constraints_t asn_PER_type_UE_NGAP_IDs_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 2,  2,  0,  2 }	/* (0..2) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_UE_NGAP_IDs_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct UE_NGAP_IDs, choice.uE_NGAP_ID_pair),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UE_NGAP_IDs, choice.choice_Extensions),
...
static asn_CHOICE_specifics_t asn_SPC_UE_NGAP_IDs_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_UE_NGAP_IDs = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_UE_NGAP_IDs_constr_1, CHOICE_constraint },
