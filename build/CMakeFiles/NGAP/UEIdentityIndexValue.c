...
asn_TYPE_member_t asn_MBR_UEIdentityIndexValue_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct UEIdentityIndexValue, choice.indexLength10),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_indexLength10_constr_2,  memb_indexLength10_constraint_1 },
		0, 0, /* No default value */
		"indexLength10"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct UEIdentityIndexValue, choice.choice_Extensions),
...
asn_TYPE_descriptor_t asn_DEF_UEIdentityIndexValue = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_UEIdentityIndexValue_constr_1, CHOICE_constraint },
