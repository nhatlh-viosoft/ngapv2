...
static asn_per_constraints_t asn_PER_type_PWSFailedCellIDList_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 2,  2,  0,  2 }	/* (0..2) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_PWSFailedCellIDList_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PWSFailedCellIDList, choice.eUTRA_CGI_PWSFailedList),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PWSFailedCellIDList, choice.nR_CGI_PWSFailedList),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PWSFailedCellIDList, choice.choice_Extensions),
...
static asn_CHOICE_specifics_t asn_SPC_PWSFailedCellIDList_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_PWSFailedCellIDList = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_PWSFailedCellIDList_constr_1, CHOICE_constraint },
