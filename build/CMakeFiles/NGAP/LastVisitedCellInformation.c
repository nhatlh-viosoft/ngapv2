...
asn_TYPE_member_t asn_MBR_LastVisitedCellInformation_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LastVisitedCellInformation, choice.nGRANCell),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LastVisitedCellInformation, choice.choice_Extensions),
...
asn_TYPE_descriptor_t asn_DEF_LastVisitedCellInformation = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_LastVisitedCellInformation_constr_1, CHOICE_constraint },
