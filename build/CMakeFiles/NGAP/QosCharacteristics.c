...
asn_TYPE_member_t asn_MBR_QosCharacteristics_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct QosCharacteristics, choice.nonDynamic5QI),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct QosCharacteristics, choice.dynamic5QI),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct QosCharacteristics, choice.choice_Extensions),
...
asn_TYPE_descriptor_t asn_DEF_QosCharacteristics = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_QosCharacteristics_constr_1, CHOICE_constraint },
