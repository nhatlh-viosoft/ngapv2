...
static asn_TYPE_member_t asn_MBR_UserLocationInformation_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct UserLocationInformation, choice.userLocationInformationEUTRA),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UserLocationInformation, choice.userLocationInformationNR),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UserLocationInformation, choice.userLocationInformationN3IWF),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UserLocationInformation, choice.choice_Extensions),
...
asn_TYPE_descriptor_t asn_DEF_UserLocationInformation = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_UserLocationInformation_constr_1, CHOICE_constraint },
