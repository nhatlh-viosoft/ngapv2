...
static asn_TYPE_member_t asn_MBR_UEPagingIdentity_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct UEPagingIdentity, choice.fiveG_S_TMSI),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UEPagingIdentity, choice.choice_Extensions),
...
asn_TYPE_descriptor_t asn_DEF_UEPagingIdentity = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_UEPagingIdentity_constr_1, CHOICE_constraint },
